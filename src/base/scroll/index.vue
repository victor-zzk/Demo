<template>
  <swiper :options="swiperOption" ref="swiper">
    <div class="mine-scroll-pull-down" v-if="pullDown">
      <loading :text="pullDownText" ref="pullDownLoading"></loading>
    </div>
    <swiper-slide>
      <slot></slot>
    </swiper-slide>
    <div class="mine-scroll-pull-up" v-if="pullUp">
      <loading :text="pullUpText" ref="pullUpLoading"></loading>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      scroll() {
        ...
        console.log(this.$refs.swiper.swiper.translate);
        if (this.pulling) {
          return;
        }
